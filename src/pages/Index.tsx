...
const getTranslations = (minimumStay: number) => ({
  nl: {
    ...
    location: {
      title: "De Omgeving",
      valencia: { title: "Valencia centrum", detail: "25 min met de metro" },
      beach: { title: "Strand", detail: "20 min met de auto · Playa de Pinedo & El Saler" },
      shops: { title: "Supermarkt & restaurants", detail: "5 min met de auto" },
      airport: { title: "Vliegveld Valencia", detail: "20 min met de auto" },
    ...
    contact: {
      ...
      formSuccess: "Bericht verstuurd! We nemen zo snel mogelijk contact met je op.",
      formError: "Er ging iets mis. Probeer het opnieuw of stuur een WhatsApp.",
    },
    footer: {
  ...
  en: {
    ...
    location: {
      ...
      valencia: { title: "Valencia center", detail: "25 min by metro" },
      beach: { title: "Beach", detail: "20 min by car · Playa de Pinedo & El Saler" },
      shops: { title: "Supermarket & restaurants", detail: "5 min by car" },
      airport: { title: "Valencia Airport", detail: "20 min by car" },
    ...
    contact: {
      ...
      formError: "Something went wrong. Please try again or send a WhatsApp.",
    },
    footer: {
      ...
      <section id="location" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-10 mb-10">
          <FadeInSection className="w-full max-w-2xl">
            <div className="rounded-xl overflow-hidden shadow-lg aspect-video bg-muted max-h-[350px] border-2 border-border ring-1 ring-primary/10">
              <iframe
      ...
      <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-border bg-background">
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-3 gap-8 mb-8">
            {/* Left: Brand */}
            <div>
              <img src={logoColor} alt="Casita Valencia" className="h-20 w-auto -mb-1" />
